...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Volt::route('eventos/{evento}/comprovativo', 'eventos.comprovativo')->name('eventos.comprovativo');

    Volt::route('admin/comprovativos', 'admin.comprovativos')->middleware('can:validar_pagamentos')->name('admin.comprovativos');
