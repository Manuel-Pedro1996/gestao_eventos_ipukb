...
<div class="p-6 w-full">
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
        <div>
            <h1 class="text-2xl font-bold tracking-tight text-blue-800 dark:text-blue-800">Editar Cliente</h1>
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Alterar dados do cliente</p>    
        </div> 
