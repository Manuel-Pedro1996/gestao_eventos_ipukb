            ...
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-4">Banco / Referência</th>
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tr class="bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                        ...
                        <td class="px-6 py-4 text-xs whitespace-nowrap">
                            <div class="font-bold text-gray-800 dark:text-gray-200">{{ $inscricao->banco ?? 'N/D' }}</div>
                            <div class="text-gray-500 dark:text-gray-400">{{ $inscricao->referencia_pagamento ?? 'Sem ref.' }}</div>
                        </td>
